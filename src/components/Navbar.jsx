        ...
        <div className='nav-options'>
          <ul>
              ...
              {(window.location.href === "http://localhost:3000/" || window.location.href === "http://localhost:3000/#popular") ?
                ...
                {(window.location.href === "http://localhost:3000/" || window.location.href === "http://localhost:3000/#recipies" || window.location.href === "http://localhost:3000/#trending") ?
                <a href="#recipies"><li>Trending</li></a>
                :
                <Link to='/#recipies'><li>Trending</li></Link>
                }
          </ul>
